...
feature_map = ExpPowerORF(input_dim=d, num_features=p, alpha=1.2, shape_matrix=M)
...
feature_map = ExpPowerRFF(input_dim=d, num_features=p, alpha=1.2, shape_matrix=M)
DEVICE = feature_map.device
X = torch.randn(n,d).to(DEVICE)
